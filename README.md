...
**트러블 슈팅**<br>
### 1. Cors 에러 : 처음으로 서버를 개발하면서 클라이언트와 연결하는 과정에서 CORS 에러를 경험했다.
...
### 2.500 Internal Server Error : 로컬 환경에서는 너무 잘 동작하다가 꼭 배포 하고 나면 500 Internal Server Error가 발생했다. 구글링을 계속 시도 했지만 서버 내부의 에러라고만 나오고 해결 방법이 각양 각색이였다.
